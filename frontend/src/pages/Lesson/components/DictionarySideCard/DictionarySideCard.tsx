   ...
   return (
      <div className="side-card-container">
         ...
         <div className="d-flex flex-column">
            ...
            <p>Open your dictionary to see all your discovered words</p>
         </div>
      </div>
   )
}

export default DictionarySideCard